...
public class Constants {
    ...
    public static final String REQUEST_URL = "http://" + LoginActivity.IP + ":" + PORT + "/lifesupporter/api/did/broadcast?androidId=" + LoginActivity.ANDROID_ID;
    public static final String BASE_URL = "http://" + LoginActivity.IP + ":" + PORT + "/lifesupporter/";
